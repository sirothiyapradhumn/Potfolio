...
;// CONCATENATED MODULE: ./src/modules/typeWriter.js
var TypeWriter = function TypeWriter(txtElement, words, wait) {
...
/* harmony default export */ const typeWriter = (TypeWriter);
...
addThemeClass(getBodyClass, getBtnClass); // init typeWriter

window.onload = function () {
  // TypeWriter fore roles.
  var txtElement = document.querySelector(".role");
